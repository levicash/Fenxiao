<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="LuckDraw.aspx.cs" Inherits="Web_Project.View.LuckDraw" %>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>抽奖</title>
    <link href="Styles/member.css" rel="stylesheet" type="text/css" />
    <link href="Roulette/css/reset.css" rel="stylesheet" />
    <link href="Roulette/css/common.css" rel="stylesheet" />
    <link href="Roulette/css/jqueryui/jqueryui.css" rel="stylesheet" />

    <script type="text/javascript" src="Roulette/js/jquery.min.js"></script>
    <script type="text/javascript" src="Roulette/js/jqueryui.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    turnplate.lotteryType = jsonobj;//添加奖品json
                    turnplate.lotteryList = [];
                    for (var i = 0; i < jsonobj.length; i++) {
                        turnplate.lotteryList.push(jsonobj[i].PName);//添加奖品名称数组
                        turnplate.lotteryDes.push(jsonobj[i].PComment);//添加奖品评价数组
                    }
        ...
        function insertWinning() {
            ...
            var PGrade = turnplate.lotteryIndex + 1;
    ...
    <style type="text/css">
    /*body{background:url('Roulette/img/turnplate/bg_01.jpg') top center no-repeat #fff;font:Arial,Helvetica,sans-serif;}*/
    #header{width:960px;margin:0 auto;position:relative;}
    #turnplatewrapper{height:592px;width:592px;background:url('Roulette/img/turnplate/plate_06.png') top left no-repeat;left:50px;top:20px;position:absolute;-moz-user-select:none;user-select:none;}
    #turnplate{height:592px;width:592px;background:url('Roulette/img/turnplate/plate_05.png') top left no-repeat;}
    #turnplate #awards{position:absolute;width:100%;height:100%;background:url('Roulette/img/turnplate/plate_03.png') top left no-repeat;}
    #platebtn{position:absolute;top:218px;left:218px;background:url('Roulette/img/turnplate/plate_04.png') top left no-repeat;height:155px;width:155px;cursor:pointer;}
    #platebtn.hover{background-position:0 -155px }
    #turnplate #platebtn.click{background-position:0 -310px }
    #gift{width:398px;height:89px;position:absolute;left:90px;top:720px;}
    ...
    #top-menu-wrapper{height:51px;background:url('Roulette/img/turnplate/bg_02.png') top center repeat-x;margin-bottom:-51px;}
    ...
    #top-menu .user{padding-left:30px;display:inline-block;height:50px;color:#fff;background:url('Roulette/img/turnplate/bg_03.png') 0 16px no-repeat;}
    </style>
    <style type="text/css">
    /*jquery ui 定制 */
    ...
    body .ui-widget-overlay{_filter:alpha(opacity=60);}
