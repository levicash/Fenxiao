<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSingImg.aspx.cs" Inherits="Web_Project.View.admin_.Product.AddSingImg" %>
...
<body>
    ...
    <div class="formbody">
        <div class="tools">
            <div class="serdiv fl">
                正在为产品：<span style="color: red; font-weight: bold;"><asp:Literal ID="Literal2" runat="server"></asp:Literal></span>&nbsp;修改更多图片
            </div>
        </div>
        <table class="table" cellspacing="1" cellpadding="10" width="99%" border="0">
            <tr>
                <td class="td_bg" style="width: 7%;">
                    上传图片
                </td>
