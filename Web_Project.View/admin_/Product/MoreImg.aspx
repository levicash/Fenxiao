<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoreImg.aspx.cs" Inherits="Web_Project.View.admin_.Product.MoreImg" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            Operating("ws_MoreImgInfo");
        });
    </script>
    <title>产品更多图片展示</title>
</head>
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
            <div class="serdiv fl">
                产品：<span style="color: red; font-weight: bold;"><asp:Literal ID="Literal2" runat="server"></asp:Literal></span>&nbsp;多图展示
            </div>
            <ul class="toolbar">
                <li class="click">
                    <asp:Button ID="Button1" runat="server" Text="添&nbsp;加" CssClass="button_add" OnClick="Button1_Click" />
                </li>
            </ul>
        </div>
                ...
                <asp:Repeater ID="repProduct" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href='AddSingImg.aspx?id=<%# Eval("Id") %>&tid=<%# Eval("Type") %>' class="tablelink">
                                    修改</a>&nbsp;|&nbsp;<a href="javascript:void(0)" id="SingleDel" pid="<%#Eval("id") %>"
