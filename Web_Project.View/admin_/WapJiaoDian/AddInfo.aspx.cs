...
namespace Web_Project.View.admin_.WapJiaoDian
{
    public partial class AddInfo : System.Web.UI.Page
    {
        ...
        protected void ProShow()
        {
            if (Request["id"] != null)
            {
                ...
                string strSql = "select *  from ws_WapJiaoDian  where Id=" + pid;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request["id"] != null)
                {
                    ...
                    string strSql = "update ws_WapJiaoDian set Title='" + title + "',Address='" + address + "',AddTime='" + date + "',IsOr=" + isor + ",Orders=" + order + "";
                    if (NewName != "")
                    {
                        strSql += ",ImgName='" + NewName + "'";
                        string sqlPic = "select * from ws_WapJiaoDian where Id = " + pid + "";
                ...
                else
                {
                    ...
                    strSql = "insert into ws_WapJiaoDian";
