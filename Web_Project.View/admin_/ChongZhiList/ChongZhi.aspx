<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChongZhi.aspx.cs" Inherits="Web_Project.View.admin_.ChongZhiList.ChongZhi" %>
...
<head runat="server">
    ...
    <script src="../Scripts/chongzhish.js" type="text/javascript"></script>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%# Eval("ShenHe").ToString() == "1" ? "<a href='javascript:void(0)' zid=" + Eval("id") + " zname=" + Eval("Rname") + " zprice=" + Eval("Money") + " page="+page+" class='shenhe' style='color: blue; text-decoration: underline;'>未审核</a>" : "<span style='color:red;'>已审核</span>"%>
                            </td>
                            <td>
