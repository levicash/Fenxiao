<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CzList.aspx.cs" Inherits="Web_Project.View.admin_.ChongZhiList.CzList" %>
        ...
        $(document).ready(function () {
            $(".outside").click(function () {
                ...
                layer.open({
                    ...
                    shade: 0.8,
                    area: ['95%', '90%'],
                    content: 'CzInfo.aspx?cname=' + cname //iframe的url
                });
            });
        });
    </script>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="tablelink outside" cname="<%#Eval("Rname") %>"
