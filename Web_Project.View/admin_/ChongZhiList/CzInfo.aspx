<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CzInfo.aspx.cs" Inherits="Web_Project.View.admin_.ChongZhiList.CzInfo" %>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%# Eval("ShenHe").ToString()=="1"?"未审核":"<span style='color:red;'>已审核</span>"%>
                            </td>
                            <td>
