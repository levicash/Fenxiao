<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="Web_Project.View.admin_.ManagesUser.UserList" %>
...
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
            <ul class="toolbar">
                <li class="click"><a href="AddUserList.aspx"><span>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href='AddUserList.aspx?pid=<%# Eval("Id") %>' style="text-decoration: none; color: black;">
                                    <%# Eval("UserName")%></a>
                            </td>
                            <td>
                                <%#Eval("btitle") %>
                            ...
                            <td>
                                <a href="UserCompeEdit.aspx?logid=<%#Eval("id") %>" style="color: #f00; font-weight: bold;">
                                    权限</a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href='AddUserList.aspx?pid=<%# Eval("Id") %>' class="tablelink">修改</a>&nbsp;|&nbsp;<a
