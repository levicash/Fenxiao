...
namespace Web_Project.View.admin_.Advertising
{
    public partial class AddInfo : System.Web.UI.Page
    {
        ...
        protected void ProShow()
        {
            if (Request["id"] != null)
            {
                ...
                string strSql = "select *  from ws_Advertising  where Id=" + pid;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request["id"] != null)
                {
                    ...
                    string strSql = "update ws_Advertising set Title='" + title + "',Address='" + address + "',AddTime='" + date + "',IsOr=" + isor + ",Orders=" + order + "";
                    if (NewName != "")
                    {
                        strSql += ",ImgName='" + NewName + "'";
                        string sqlPic = "select * from ws_Advertising where Id = " + pid + "";
                ...
                else
                {
                    ...
                    string strSql = "";
                    strSql = "insert into ws_Advertising";
                    strSql += "(Title,ImgName,Address,AddTime,IsOr,Orders) values ";
                    strSql += "('" + title + "','" + NewName + "','" + address + "','" + date + "'," + isor + "," + order + ")";
